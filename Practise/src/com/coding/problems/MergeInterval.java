...
public class MergeInterval {
	...
	public static int[][] merge(int[][] intervals) {
		...
		// for output using LinkedList, because, we need to compare with the last
		// element
		LinkedList<int[]> output = new LinkedList<>();

		for (int[] interval : intervals) {
			// there is an overlap if second array first element is <= first array or
			// computed array second element,
